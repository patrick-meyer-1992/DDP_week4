...
The first plot extracts the number of views each show has, orders them by that number and displays the 10 most watched shows.
...
```{r Weekly Distribution, echo=FALSE, out.width="100%"}
        ...
        combPlot = combPlot %>% add_annotations(x = c((0.5/2), ((0.5+1)/2)), 
                                                y = 0.98, 
